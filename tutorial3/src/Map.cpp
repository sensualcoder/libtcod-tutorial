...
namespace tcodtutorial
{
    ...
    class BspListener : public ITCODBspCallback 
    {
        public:
            ...
            bool visitNode(TCODBsp* node, void* userData) 
            {
                ...
                {    
                    ...
                    if(RoomNum > 0) 
                    {
                        Room room = this->Rooms[RoomNum - 1];

                        // dig a corridor from last room
                        this->GameMap.Dig(room.PosX, room.PosY, x + w / 2, room.PosY);
                        this->GameMap.Dig(x + w / 2, room.PosY, x + w / 2, y + h / 2);
                    }

                    this->Rooms.push_back(Room { x + w / 2, y + h / 2 } );
                    ++RoomNum;
                }
                return true;
            }
        ...
        private:
            ...
            std::vector<Room> Rooms; // list of room center positions
    };
